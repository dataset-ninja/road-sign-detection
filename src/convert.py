...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = "/Users/iwatkot/Downloads/ninja/datasets/road-sign-detection"
    ...
    obj_class_trafficlight = sly.ObjClass("trafficlight", sly.Rectangle)
    obj_class_stop = sly.ObjClass("stop", sly.Rectangle)
    obj_class_speedlimit = sly.ObjClass("speedlimit", sly.Rectangle)
    obj_class_crosswalk = sly.ObjClass("crosswalk", sly.Rectangle)

    project = api.project.create(workspace_id, project_name, change_name_if_conflict=True)

    meta = sly.ProjectMeta(
        obj_classes=[
            obj_class_trafficlight,
            obj_class_stop,
            obj_class_speedlimit,
            obj_class_crosswalk,
        ]
    )
